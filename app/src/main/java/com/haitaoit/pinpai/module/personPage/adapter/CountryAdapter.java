...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.ViewHolder> {
    ...
    private List<GetCountryListObj.ResponseBean.DycaregorylistBean> mDate;

    public CountryAdapter(Context context, List<GetCountryListObj.ResponseBean.DycaregorylistBean> lists) {
