...
public class SearchGoodsAdapter extends RecyclerView.Adapter<SearchGoodsAdapter.ViewHolder> {
    ...
    public SearchGoodsAdapter(Context context, List<DateBeatJsonObj.ResponseBean> lists,String mMessageType) {
    ...
    public SearchGoodsAdapter.OnItemClickListener getOnItemClickListener() {
        return onItemClickListener;
    }

    public void setOnItemClickListener(SearchGoodsAdapter.OnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    private SearchGoodsAdapter.OnItemClickListener onItemClickListener;

    @Override
    public SearchGoodsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = inflater.inflate(R.layout.item_search_goods_adapter, viewGroup, false);

        return new SearchGoodsAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final SearchGoodsAdapter.ViewHolder holder, final int position) {
