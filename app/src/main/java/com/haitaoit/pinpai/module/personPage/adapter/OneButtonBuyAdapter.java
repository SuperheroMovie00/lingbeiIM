...
public class OneButtonBuyAdapter extends RecyclerView.Adapter<OneButtonBuyAdapter.MyViewHolder> {
    ...
    public OneButtonBuyAdapter(Context context, List<GetUserGooddListObj.ResponseBean> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = mInflater.inflate(R.layout.item_onebutton_buy_adapter, parent, false);
