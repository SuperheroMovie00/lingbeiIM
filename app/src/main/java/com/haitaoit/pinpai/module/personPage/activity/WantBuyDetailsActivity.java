...
public class WantBuyDetailsActivity extends BaseActivity

{
    ...
    protected int getContentView() {
        return R.layout.want_buy_details_activity;
    }
...
//                    }
    ...
    public void onViewClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.my_tv_editor:
                ...
                RxActivityUtils.skipActivityAndFinish(mContext, EditorWantBuyActivity.class, edBundle);
                break;
    ...
    private void initDelete() {
        ...
        com.haitaoit.pinpai.module.personPage.network.ApiRequest.PostNeedDelete(map, item, new MyCallBack<ResponseObj>(mContext) {
            @Override
