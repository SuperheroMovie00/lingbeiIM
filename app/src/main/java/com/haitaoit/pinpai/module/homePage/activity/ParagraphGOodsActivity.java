...
public class ParagraphGOodsActivity extends BaseActivity {
    ...
    private void initCollList(final boolean isRefresh) {
        ...
        ApiRequest.GetSameGoodsList(map, new MyCallBack<DateBeatJsonObj>(mContext) {
            @Override
...
//                    if (response.getErrMsg().equals("暂无内容")) {
//                        pcflRefresh.setVisibility(View.GONE);
