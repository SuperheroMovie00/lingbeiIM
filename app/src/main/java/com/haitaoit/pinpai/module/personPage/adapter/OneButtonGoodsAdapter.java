...
public class OneButtonGoodsAdapter extends RecyclerView.Adapter<OneButtonGoodsAdapter.MyViewHolder> {
    ...
    public OneButtonGoodsAdapter(Context context, List<GetUserGooddListObj.ResponseBean> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = mInflater.inflate(R.layout.item_onebutton_goods_adapter, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tvPrices.setText("¥  " + mDataList.get(position).getCount());
//        holder.tvAddress.setText("求货地：" + mDataList.get(position).getSource());
        holder.tvName.setText(mDataList.get(position).getSource());
        holder.tvGoodNum.setText("共" + mDataList.get(position).getStock() + "件库存");
