...
public class SearchQiuActivcty extends BaseActivity {
    ...
    protected void initView() {
        rxTitle.setTitle("搜索拎贝求购");
        tvSubmit.setText("提交新求购信息并发布");
        tvNotReplace.setText("没有找到你的求购？");
        tvNewReplace.setText("提交新求购并发布");
    ...
    private void initAdapter() {
        ...
        rvCollecView.setAdapter(mSearchGoodsAdapter = new SearchGoodsAdapter(mContext, mDataList, "2"));
