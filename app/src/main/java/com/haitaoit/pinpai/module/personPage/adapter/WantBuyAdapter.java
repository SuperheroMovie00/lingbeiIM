...
public class WantBuyAdapter extends RecyclerView.Adapter<WantBuyAdapter.MyViewHolder> {
    ...
    public WantBuyAdapter(Context context, List<GetUserGooddListObj.ResponseBean> dataList) {
    ...
    private WantBuyAdapter.CartEventCallback callback;

    public void setCallback(WantBuyAdapter.CartEventCallback callback) {
    ...
    public WantBuyAdapter.OnItemClickListener getOnItemClickListener() {
        return onItemClickListener;
    }

    public void setOnItemClickListener(WantBuyAdapter.OnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    private WantBuyAdapter.OnItemClickListener onItemClickListener;

    @Override
    public WantBuyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = mInflater.inflate(R.layout.item_supply_adapter, parent, false);
        WantBuyAdapter.MyViewHolder myViewHolder = new WantBuyAdapter.MyViewHolder(rootView);
        return myViewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(final WantBuyAdapter.MyViewHolder holder, final int position) {
        ...
        holder.tvQiuhuodi.setText("求购地：" + mDataList.get(position).getSource());
