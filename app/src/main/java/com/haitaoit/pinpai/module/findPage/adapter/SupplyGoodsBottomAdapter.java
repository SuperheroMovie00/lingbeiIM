...
public class SupplyGoodsBottomAdapter extends RecyclerView.Adapter<SupplyGoodsBottomAdapter.ViewHolder> {
    ...
    private List<MyYouShiObj.ResponseBean> mDate;

    public SupplyGoodsBottomAdapter(Context context, List<MyYouShiObj.ResponseBean> lists) {
