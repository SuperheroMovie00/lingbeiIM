...
public class CompanyWeChatActivity extends BaseActivity
{
    ...
    protected int getContentView() {
        return R.layout.company_wechat_activity;
    }

    @Override
    protected void initView() {
        edMess.setText(getIntent().getStringExtra("userWeChatQQ"));
        ...
        ApiRequest.PostUserMobileEdit(map, new PostUserInfoUpdatetItem(file), new MyCallBack<ResponseObj>(mContext) {
            ...
            public void onSuccessful(ResponseObj response) {
                if (response.getErrCode() == 0) {
                    ...
                    intent.putExtra(Constant.IParam.company_wechat,getSStr(edMess));
