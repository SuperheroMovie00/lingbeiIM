...
import com.haitaoit.pinpai.module.homePage.adapter.RecommendPurchaseAdapter;
...
public class RecommendPurchaseFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        rvHomeHotSecond.setAdapter(mRecommendSoureSecondAdapter = new RecommendSoureSecondAdapter(mContext, mDateBeat,"2"));
    ...
    private void initSuppleBottom() {
        ...
        map.put("pagesize", "4");
        map.put("sign", GetSign.getSign(map));
        ApiRequest.GetNeedList4(map, new MyCallBack<TuiJianHuoYuanObj>(mContext) {
            @Override
