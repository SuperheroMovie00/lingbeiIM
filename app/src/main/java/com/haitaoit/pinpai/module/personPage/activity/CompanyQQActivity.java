...
public class CompanyQQActivity extends BaseActivity
{
    ...
    protected int getContentView() {
        return R.layout.company_qq_activity;
    }

    @Override
    protected void initView() {
        edMess.setText(getIntent().getStringExtra("userQQ"));
        ...
        ApiRequest.PostUserMobileEdit(map, new PostUserInfoUpdatetItem(file), new MyCallBack<ResponseObj>(mContext) {
            ...
            public void onSuccessful(ResponseObj response) {
                if (response.getErrCode() == 0) {
                    ...
                    intent.putExtra(Constant.IParam.company_qq,getSStr(edMess));
