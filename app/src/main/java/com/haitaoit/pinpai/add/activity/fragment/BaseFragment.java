...
import com.haitaoit.pinpai.add.activity.LoginActivity;
                    ...
                    public void onClick(View v) {
                        switch (v.getId()) {
                            case R.id.jmui_cancel_btn:
                                Intent intent = new Intent(mContext, com.haitaoit.pinpai.module.loginPage.activity.LoginActivity.class);
                            ...
                            case R.id.jmui_commit_btn:
                                JMessageClient.login(SharePreferenceManager.getCachedUsername(), SharePreferenceManager.getCachedPsw(), new BasicCallback() {
                                    ...
                                    public void gotResult(int responseCode, String responseMessage) {
                                        if (responseCode == 0) {
                                            Intent intent = new Intent(mContext, com.haitaoit.pinpai.module.homePage.activity.MainActivity.class);
                                            startActivity(intent);
                                        }
                                    }
                                });
