...
import com.haitaoit.pinpai.add.adapter.AllMembersAdapter;
...
//        mSideBar.setTextView(mLetterHintTv);
        ...
        mIsDeleteMode = getIntent().getBooleanExtra(ExitApplication.DELETE_MODE, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_btn:
                    ...
                    setResult(ExitApplication.RESULT_CODE_ALL_MEMBER, intent);
                    finish();
                    break;
                case R.id.right_btn:
                    if (mIsDeleteMode) {
