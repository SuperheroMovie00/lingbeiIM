...
import com.haitaoit.pinpai.add.activity.ChatDetailActivity;
import com.haitaoit.pinpai.add.activity.FeedbackActivity;
import com.haitaoit.pinpai.add.activity.FriendInfoActivity;
import com.haitaoit.pinpai.add.activity.GroupAvatarActivity;
import com.haitaoit.pinpai.add.activity.GroupGridViewActivity;
import com.haitaoit.pinpai.add.activity.GroupNotFriendActivity;
import com.haitaoit.pinpai.add.activity.MainActivity;
import com.haitaoit.pinpai.add.activity.MembersInChatActivity;
import com.haitaoit.pinpai.add.activity.PersonalActivity;
import com.haitaoit.pinpai.add.activity.UpdateRemarkActivity;
import com.haitaoit.pinpai.add.activity.VerificationActivity;
import com.haitaoit.pinpai.add.activity.historyfile.activity.HistoryFileActivity;
import com.haitaoit.pinpai.add.adapter.GroupMemberGridAdapter;
import com.haitaoit.pinpai.ExitApplication;
import com.haitaoit.pinpai.add.database.FriendEntry;
import com.haitaoit.pinpai.add.database.FriendRecommendEntry;
...
import com.haitaoit.pinpai.module.personPage.activity.SuggestionActivity;
import com.haitaoit.pinpai.utils.DialogCreator;
import com.haitaoit.pinpai.utils.ToastUtil;
import com.haitaoit.pinpai.view.ChatDetailView;
import com.haitaoit.pinpai.view.SlipButton;
...
public class ChatDetailController implements OnClickListener, OnItemClickListener,
    ...
    public void initData() {
        ...
        mGroupId = intent.getLongExtra(ExitApplication.GROUP_ID, 0);
        mTargetId = intent.getStringExtra(ExitApplication.TARGET_ID);
        mTargetAppKey = intent.getStringExtra(ExitApplication.TARGET_APP_KEY);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.return_btn:
                ...
                intent.putExtra(ExitApplication.CONV_TITLE, getName());
                intent.putExtra(ExitApplication.MEMBERS_COUNT, mMemberInfoList.size());
                mContext.setResult(ExitApplication.RESULT_CODE_CHAT_DETAIL, intent);
                mContext.finish();
                break;
            ...
            case R.id.tv_moreGroup:
                ...
                intent.putExtra(ExitApplication.DELETE_MODE, false);
                mContext.startActivityForResult(intent, ExitApplication.REQUEST_CODE_ALL_MEMBER);
                break;
                                        ...
                                        if (content.getContentType() == ContentType.image) {
                                            ...
                                            if (!TextUtils.isEmpty(localPath)) {
                                                ...
                                                if (file.exists()) {
                                                    ...
                                                    File copyFile = new File(ExitApplication.FILE_DIR + fileContent.getFileName());
            ...
            case R.id.update_name:
                RxActivityUtils.skipActivity(mContext, UpdateRemarkActivity.class);
                break;
        }
    }
    ...
    public void onItemClick(AdapterView<?> viewAdapter, View view, final int position, long id) {
        ...
        if (mIsGroup) {
            ...
            if (position < mCurrentNum) {
                ...
                intent.putExtra(ExitApplication.DELETE_MODE, true);
                intent.putExtra(ExitApplication.GROUP_ID, mGroupId);
            ...
            mContext.startActivityForResult(intent, ExitApplication.REQUEST_CODE_FRIEND_INFO);
        } else if (position == mCurrentNum) {
