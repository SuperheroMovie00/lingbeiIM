...
import com.haitaoit.pinpai.utils.SortConvList;
import com.haitaoit.pinpai.utils.SortTopConvList;
...
import com.haitaoit.pinpai.view.ConversationListView;
import com.haitaoit.pinpai.view.SwipeLayoutConv;
...
//                //会话界面时间
                ...
                if (mAtAll.get(position) && ExitApplication.isAtall.get(gid) != null && ExitApplication.isAtall.get(gid)) {
                ...
                } else if (mArray.get(position) && ExitApplication.isAtMe.get(gid) != null && ExitApplication.isAtMe.get(gid)) {
                    //有人@我 文字提示
                    ...
                    if (lastMsg.getTargetType() == ConversationType.group && !contentStr.equals("[群成员变动]")) {
                        ...
                        if (ExitApplication.isAtall.get(gid) != null && ExitApplication.isAtall.get(gid)) {
                            content.setText("[@所有人] " + fromName + ": " + contentStr);
                        } else if (ExitApplication.isAtMe.get(gid) != null && ExitApplication.isAtMe.get(gid)) {
