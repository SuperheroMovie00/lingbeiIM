package com.haitaoit.pinpai.add.activity.historyfile.controller;
...
import com.haitaoit.pinpai.add.activity.historyfile.fragment.AudioFileFragment;
import com.haitaoit.pinpai.add.activity.historyfile.fragment.DocumentFileFragment;
import com.haitaoit.pinpai.add.activity.historyfile.fragment.ImageFileFragment;
import com.haitaoit.pinpai.add.activity.historyfile.fragment.OtherFileFragment;
import com.haitaoit.pinpai.add.activity.historyfile.fragment.VideoFileFragment;
import com.haitaoit.pinpai.add.activity.historyfile.view.HistoryFileView;
import com.haitaoit.pinpai.add.adapter.ViewPagerAdapter;
import com.haitaoit.pinpai.ExitApplication;
import com.haitaoit.pinpai.add.entity.SelectedHistoryFileListener;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.delete_file_btn:
                ...
                ExitApplication.ids.clear();
                for (Integer id : idMap.keySet()) {
                    //把即将被删除的消息添加进集合中,注意获取message的id是从map中拿出来的.
                    ExitApplication.ids.add(conversation.getMessage(idMap.get(id)));
