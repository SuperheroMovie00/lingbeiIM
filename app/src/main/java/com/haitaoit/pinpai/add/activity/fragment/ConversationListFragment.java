...
import com.haitaoit.pinpai.add.controller.ConversationListController;
import com.haitaoit.pinpai.add.controller.MenuItemController;
import com.haitaoit.pinpai.add.entity.Event;
import com.haitaoit.pinpai.view.ConversationListView;
import com.haitaoit.pinpai.view.MenuItemView;
...
public class ConversationListFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mThread = new HandlerThread("MyMessageActivity");
        mThread.start();
    ...
    public void onEvent(MessageEvent event) {
        ...
        if (msg.getTargetType() == ConversationType.group) {
            ...
            if (conv != null && mConvListController != null) {
                if (msg.isAtMe()) {
                    ExitApplication.isAtMe.put(groupId, true);
                    mConvListController.getAdapter().putAtConv(conv, msg.getId());
                }
                if (msg.isAtAll()) {
                    ExitApplication.isAtall.put(groupId, true);
