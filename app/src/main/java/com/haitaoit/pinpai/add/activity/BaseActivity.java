...
import com.haitaoit.pinpai.module.homePage.activity.*;
import com.haitaoit.pinpai.module.loginPage.activity.*;
...
import com.haitaoit.pinpai.utils.swipeback.app.SwipeBackActivity;
                    ...
                    public void onClick(View v) {
                        switch (v.getId()) {
                            case R.id.jmui_cancel_btn:
                                Intent intent = new Intent(BaseActivity.this, com.haitaoit.pinpai.module.loginPage.activity.LoginActivity.class);
                                startActivity(intent);
                                break;
                            case R.id.jmui_commit_btn:
                                JMessageClient.login(SharePreferenceManager.getCachedUsername(), SharePreferenceManager.getCachedPsw(), new BasicCallback() {
                                    ...
                                    public void gotResult(int responseCode, String responseMessage) {
                                        if (responseCode == 0) {
                                            Intent intent = new Intent(BaseActivity.this, com.haitaoit.pinpai.module.homePage.activity.MainActivity.class);
                                            startActivity(intent);
                                        }
                                    }
                                });
