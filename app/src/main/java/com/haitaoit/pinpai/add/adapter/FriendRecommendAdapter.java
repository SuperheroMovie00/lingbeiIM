...
import com.haitaoit.pinpai.add.activity.SearchFriendDetailActivity;
...
import com.haitaoit.pinpai.utils.ViewHolder;
import com.haitaoit.pinpai.utils.photochoose.SelectableRoundedImageView;
import com.haitaoit.pinpai.view.SwipeLayout;
            ...
            public void gotResult(int i, String s, UserInfo userInfo) {
                if (i == 0) {
                    if (userInfo.isFriend()) {
                        ...
                        item.save();
                        FriendEntry entry = FriendEntry.getFriend(ExitApplication.getUserEntry(), item.username, item.appKey);
                        if (entry == null) {
        ...
        itemLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (entry.state.equals(FriendInvitation.INVITED.getValue())) {
                    ...
                    intent.putExtra(ExitApplication.TARGET_ID, entry.username);
                    intent.putExtra(ExitApplication.TARGET_APP_KEY, entry.appKey);
                    ...
                    JMessageClient.getUserInfo(item.username, new GetUserInfoCallback() {
                        ...
                        public void gotResult(int i, String s, UserInfo userInfo) {
                            if (i == 0) {
                                ...
                                intent1.putExtra(ExitApplication.TARGET_ID, entry.username);
                                intent1.putExtra(ExitApplication.TARGET_APP_KEY, entry.appKey);
