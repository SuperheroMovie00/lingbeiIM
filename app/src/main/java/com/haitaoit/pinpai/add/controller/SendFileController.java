...
import com.haitaoit.pinpai.add.activity.SendFileActivity;
import com.haitaoit.pinpai.add.activity.fragment.AudioFragment;
import com.haitaoit.pinpai.add.activity.fragment.DocumentFragment;
import com.haitaoit.pinpai.add.activity.fragment.ImageFragment;
import com.haitaoit.pinpai.add.activity.fragment.OtherFragment;
import com.haitaoit.pinpai.add.activity.fragment.VideoFragment;
import com.haitaoit.pinpai.add.adapter.ViewPagerAdapter;
import com.haitaoit.pinpai.ExitApplication;
import com.haitaoit.pinpai.add.entity.FileType;
import com.haitaoit.pinpai.add.entity.UpdateSelectedStateListener;
import com.haitaoit.pinpai.utils.BitmapLoader;
import com.haitaoit.pinpai.view.SendFileView;
...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public SendFileController(SendFileActivity context, SendFileView view) {
        ...
        String targetId = mContext.getIntent().getStringExtra(ExitApplication.TARGET_ID);
        String targetAppKey = mContext.getIntent().getStringExtra(ExitApplication.TARGET_APP_KEY);
        long groupId = mContext.getIntent().getLongExtra(ExitApplication.GROUP_ID, 0);
        if (groupId != 0) {
            ...
            if (controller != null) {
                switch (msg.what) {
                    case SEND_FILE:
                        ...
                        intent.putExtra(ExitApplication.MsgIDs, controller.mMsgIds);
                        controller.mContext.setResult(ExitApplication.RESULT_CODE_SEND_FILE, intent);
