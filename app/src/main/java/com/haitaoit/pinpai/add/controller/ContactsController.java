...
import com.haitaoit.pinpai.add.activity.FriendRecommendActivity;
import com.haitaoit.pinpai.add.activity.GroupActivity;
import com.haitaoit.pinpai.add.activity.SearchContactsActivity;
import com.haitaoit.pinpai.add.activity.SearchForAddFriendActivity;
import com.haitaoit.pinpai.add.adapter.StickyListAdapter;
...
import com.haitaoit.pinpai.utils.pinyin.PinyinComparator;
        ...
        ContactManager.getFriendList(new GetUserInfoListCallback() {
            ...
            public void gotResult(int responseCode, String responseMessage, List<UserInfo> userInfoList) {
                ...
                if (responseCode == 0) {
                    ...
                    List<FriendEntry> friends = ExitApplication.getUserEntry().getFriends();
