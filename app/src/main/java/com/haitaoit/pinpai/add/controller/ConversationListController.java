...
import com.haitaoit.pinpai.add.adapter.ConversationListAdapter;
...
public class ConversationListController implements View.OnClickListener,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (position > 0) {
            ...
            intent.putExtra(ExitApplication.CONV_TITLE, conv.getTitle());
            //群聊
            if (conv.getType() == ConversationType.group) {
                ...
                intent.putExtra(ExitApplication.DRAFT, getAdapter().getDraft(conv.getId()));
                ...
                intent.putExtra(ExitApplication.TARGET_APP_KEY, conv.getTargetAppKey());
                intent.putExtra(ExitApplication.DRAFT, getAdapter().getDraft(conv.getId()));
            }
            intent.setClass(mContext.getActivity(), ChatActivity.class);
