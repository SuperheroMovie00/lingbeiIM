package com.haitaoit.pinpai.utils.citychoose.view;
...
import com.haitaoit.pinpai.utils.citychoose.XmlParserHandler;
import com.haitaoit.pinpai.utils.citychoose.model.CityModel;
import com.haitaoit.pinpai.utils.citychoose.model.DistrictModel;
import com.haitaoit.pinpai.utils.citychoose.model.ProvinceModel;
import com.haitaoit.pinpai.utils.citychoose.view.adapter.ArrayWheelAdapter;
import com.haitaoit.pinpai.utils.citychoose.view.myinterface.OnWheelChangedListener;
import com.haitaoit.pinpai.utils.citychoose.view.myinterface.SelectAddressInterface;
import com.haitaoit.pinpai.utils.timechoose.NumericWheelAdapter;
...
public class SelectAddressDialog implements OnClickListener,
    ...
    public void showDateDialog(final PersonalActivity context, final UserInfo myInfo) {
        ...
        year.setCurrentItem(curYear - ExitApplication.START_YEAR);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String str = String.format(Locale.CHINA,
                        "%4d-%2d-%2d", year.getCurrentItem() + ExitApplication.START_YEAR,//1900
    ...
    private void initYear(PersonalActivity context) {
        NumericWheelAdapter numericWheelAdapter = new NumericWheelAdapter(context,
                ExitApplication.START_YEAR, ExitApplication.END_YEAR);
