...
public class ChatDetailView extends LinearLayout {
    ...
    private RelativeLayout mClear_rl, Jubao_rl;
    ...
    public void initModule() {
        ...
        Jubao_rl = (RelativeLayout) findViewById(R.id.Jubao_rl);
    ...
    public void setListeners(OnClickListener onClickListener) {
        ...
        Jubao_rl.setOnClickListener(onClickListener);
        update_name.setOnClickListener(onClickListener);}
